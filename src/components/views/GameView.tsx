...
export function GameView({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black overflow-y-auto no-scrollbar flex flex-col">
      <div className="absolute inset-0 z-0">
        <div className="w-full h-full bg-[radial-gradient(circle_at_top_right,_rgba(10,132,255,0.2),_transparent_38%),radial-gradient(circle_at_bottom_left,_rgba(255,55,95,0.18),_transparent_34%),linear-gradient(135deg,#111113_0%,#000000_55%,#171119_100%)]" />
        <div className="absolute inset-0 bg-black/40 backdrop-blur-[2px]" />
      </div>

      <div className="tablet-shell relative z-10 flex flex-col min-h-dvh w-full max-w-[920px] mx-auto">
        <header className="pt-[calc(env(safe-area-inset-top)+1.25rem)] pb-2 px-4 sm:px-6 lg:px-8 flex items-center gap-4 shrink-0">
          <button
            onClick={onBack}
          ...
          <div className="flex-1 flex justify-center">
            <div className="p-1.5 bg-[#1C1C1E] rounded-full flex items-center gap-2 border border-white/10">
              ...
              >
                <span className="text-sm leading-none">{getAvatarEmoji(players[0].avatar, players[0].role)}</span>
              ...
              >
                ...
                <span className="text-sm leading-none">{getAvatarEmoji(players[1].avatar, players[1].role)}</span>
              </div>
            </div>
          </div>
          <div className="w-10" />
        ...
        <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-5">
          <GameBoard
            boardMap={boardMap}
        ...
        <div className="w-full ios-glass rounded-t-[32px] flex flex-col items-center pt-6 pb-[calc(env(safe-area-inset-bottom)+1.5rem)] px-6 border-t border-white/10 shadow-2xl shrink-0">
          <div
